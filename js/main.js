...
const imgHtml = allImages.length > 0 ? `
  <div style="width:100%">
    <img id="main-img" src="${allImages[0]}" style="width:auto;height:auto;object-fit:contain;border-radius:8px;background:#f3ede6">
    <div style="display:flex;gap:8px;margin-top:12px;flex-wrap:wrap">
      ${allImages.map((img,i) => `
        <img src="${img}" onclick="document.getElementById('main-img').src='${img}'"
        style="width:200px;height:200px;object-fit:cover;border-radius:6px;cursor:pointer;border:2px solid ${i===0?'#c4622d':'#e8ddd4'}">
      `).join('')}
    </div>
